 ...
 * Define Constants
 */
define( 'INSPIRO_THEME_VERSION', '1.4.1' );
 ...
 */
    ...
    add_user_meta($user, 'phone', $_POST['phone']);
    ...
    echo json_encode(['status' => 'true','url' => $url, 'message' => 'user registered successfully']);
    wp_die();
}
...
function submit_login_form(){
    ...
    if ( is_wp_error($user_verify) )
    {
        ...
        $data = ['status' => 'true', 'message' => 'Login Successfully', 'url' => site_url() . "/dashboard"];
